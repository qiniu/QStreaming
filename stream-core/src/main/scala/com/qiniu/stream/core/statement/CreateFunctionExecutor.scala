...
import com.qiniu.stream.core.config.{BooleanDataType, ByteDataType, CreateFunctionStatement, DateDataType, DoubleDataType, FloatDataType, IntDataType, LongDataType, ShortDataType, SmallIntDataType, SqlStructType, StringDataType, TimeStampDataType, TinyIntDataType}
